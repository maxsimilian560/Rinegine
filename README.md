...
### Прежде чем начать работу с фреймворком советую установить [расширение](https://marketplace.visualstudio.com/items?itemName=maxsimilian560.rg-extens) для VS Code которое упрощает работу с фреймворком! Инструкция на странице расширения.

### *Теперь можно следить за самой последней версией фреймворка в ветке WIP. [Там](https://github.com/maximilian560/rinegine/tree/wip) будет храниться самая новая, но не готовая версия фреймворка!*

## Rinegine это
Лёгкий, простой и полностью самодостаточный фреймворк для программ и игр с 2-х/3-х мерной графикой!

Всё самое интересное во вкладке [Wiki](https://github.com/Maximilian560/Rinegine/wiki)!  
Новости по фреймворку и прочим проектам в моём [X (Twitter)](https://x.com/Rinemest) и на официальном сайте [rinemest.com](https://rinemest.com/news)!

### Почему Вам стоит использовать Rinegine вместо других фреймворков/движков?  
### Вот несколько причин:  
* Фреймворк активно развивается, вы можете поучаствовать в его развитии и оставить след!
* Мы преследуем самые важные цели — удобство в разработке, скорость разработки, производительность программ!
* Фреймворк имеет модульную систему и систему аддонов, вы можете написать свой аддон и скорее всего он пойдёт как часть фреймворк (будет указано авторство, так же не забудьте написать об этом мне в [телеграме](https://t.me/maxsimilian560))!
* Вы можете напрямую связаться со мной если возникнут какие-нибудь вопросы или идеи!
* В фреймворк реализованны классы которые есть в обычном STD, но работающие быстрее!
* Возможно разработка как игр так и других приложений с графикой и без с большим функционалом фреймворка!

### Что может предложить фреймворк?
### Вот самое важное:
...
### Только большего!
* Программа для ещё более простой разработки программ и удобной установки или обновления фреймворка! Ноды, сцены, моделирование, всё в одном!
* Больше оптимизации! С каждой строчкой кода наши навыки растут и с ними улучшается сам фреймворк!
