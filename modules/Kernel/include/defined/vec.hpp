...
template <class type> struct vec3 {
  ...
  inline vec3 operator+(type scalar) const {
...
template <class type> struct vec4 {
  ...
  inline vec4 operator+(type scalar) const {
...
template <class type>
inline vec2<type>::vec2(const vec3<type> &v) : x(v.x), y(v.y) {}
template <class type>
inline vec2<type>::vec2(const vec4<type> &v) : x(v.x), y(v.y) {}
...
template <class type>
inline vec4<type>::vec4(const vec2<type> &v) : x(v.x), y(v.y), z(0), w(0) {}
template <class type>
inline vec4<type>::vec4(const vec3<type> &v) : x(v.x), y(v.y), z(v.z), w(0) {}
