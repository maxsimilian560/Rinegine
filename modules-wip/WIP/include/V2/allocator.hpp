  ...
  namespace WIP {
    ...
    public:
      Allocator() {
        ...
        pool_head = SYS_GET_MEM(Allocator::page_size());
        pools = (BYTE**)pool_head + 1;
        pools[0] = SYS_GET_RAW_MEM(Allocator::page_size() * ALLOC_PAGE_COUNT * (1));
        free_list = (BYTE**)SYS_GET_RAW_MEM(Allocator::page_size() * ALLOC_PAGE_COUNT * sizeof(BYTE**));
        now_pool_size = Allocator::page_size() * ALLOC_PAGE_COUNT;
